package Sanity_Provider_Web.cukes;
...
import static Sanity_Provider_Web.pages.HomePage.*;

@CucumberOptions(features = {"src/test/resources/features/Sanity_Provider_Web"},
        monochrome = true,
        tags = "@CHECK",
        glue = {"Sanity_Provider_Web", "Sanity_Patient_Web"},
        plugin = {
...
public class SanityProviderWebCukes extends AbstractTestNGCucumberTests {
